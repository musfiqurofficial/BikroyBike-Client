...
const ProductDetail = () => {
    ...
    const { _id, product_img1, product_img2, product_img3, brand_name, detail, model_name, model_year, category, Post_date, address, km, cc, price, used_year, phone_number, seller_name } = data;
                ...
                <div className='grid grid-cols-3'>
                        ...
                        <div>
                            <div className="carousel w-full">
                                <div id="item1" className="carousel-item w-full">
                                    <img src={product_img1} className="w-full" alt='' />
                                </div>
                                <div id="item2" className="carousel-item w-full">
                                    <img src={product_img2} className="w-full" alt='' />
                                </div>
                                <div id="item3" className="carousel-item w-full">
                                    <img src={product_img3} className="w-full" alt='' />
                                </div>
                            </div>
                            <div className="flex justify-center w-full py-2 gap-2">
                                <a href="#item1"><img className='w-16' src={product_img1} alt="" /></a>
                                <a href="#item2"><img className='w-16' src={product_img2} alt="" /></a>
                                <a href="#item3"><img className='w-16' src={product_img3} alt="" /></a>
                            </div>
                        </div>
                    ...
                    <div className='bg-stone-50 shadow-lg px-5 py-8 '>
                        <div className='sticky top-28'>
                            <h3 className='text-xl font-bold'>Name: {seller_name}</h3>
                            <p className='my-3'>{km ? km : <></>}, {cc ? cc : <></>}</p>
                            <p>Address: {address}</p>
                            <h3 className='my-3'>Phone: {phone_number}</h3>
